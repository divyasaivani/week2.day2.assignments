...
public class DuplicateLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.name("emailAddress")).sendKeys("mdivyacivil13@gmail.com");
		...
		if(duplicateName.isDisplayed())
				System.out.println("Duplicate name is equal to captured name.");
		else
			System.out.println("Duplicate name is not equal to captured name.");
